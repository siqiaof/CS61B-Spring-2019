...
public class TestRouter {
    private static final String PARAMS_FILE = "../../labs/library-sp19/data/proj2c_test_inputs/path_params.txt";
    private static final String RESULTS_FILE = "../../labs/library-sp19/data/proj2c_test_inputs/path_results.txt";
    private static final int NUM_TESTS = 8;
    private static final String OSM_DB_PATH = "../../labs/library-sp19/data/proj2c_xml/berkeley-2019.osm.xml";
