...
public class TestRasterAPIHandler {
    ...
    private static final String PARAMS_FILE = "../../labs/library-sp19/data/proj2c_test_inputs/raster_params.txt";
    private static final String RESULTS_FILE = "../../labs/library-sp19/data/proj2c_test_inputs/raster_results.txt";
