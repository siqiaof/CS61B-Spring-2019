...
public class Constants {
     ...
     **/
    public static final String OSM_DB_PATH = "../../labs/library-sp19/data/proj2c_xml/berkeley-2019.osm.xml";

    /** The tile images are in the IMG_ROOT folder. */
    public static final String IMG_ROOT = "../../labs/library-sp19/data/proj2c_imgs/";
